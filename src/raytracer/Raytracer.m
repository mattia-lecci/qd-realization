...
% qdGeneratorType - see PARAMETERCFG for more info
...
% Input checking
if ~strcmp(paraCfgInput.qdGeneratorType, 'off') &&...
    ...
    for iterateTx = 1:paraCfgInput.numberOfNodes
        for iterateRx = iterateTx+1:paraCfgInput.numberOfNodes
            ...
            for iterateOrderOfReflection = 1:paraCfgInput.totalNumberOfReflections
                ...
                [outputTmp, rayVertices, triangListTmp] = mymultipath(Rx, Tx, vrx, vtx,...
                    triangReflIdxList, CADop, visibilityMatrix,...
                    MaterialLibrary, paraCfgInput.qdGeneratorType,...
